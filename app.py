...
def predict():
    ...
    if request.method == 'POST':
        ...
        if my_prediction[0][0] == 1:
            prediction='Predicted crime : Act 379-Robbery'
        elif my_prediction[0][1] == 1:
            prediction='Predicted crime : Act 13-Gambling'
        elif my_prediction[0][2] == 1:
            prediction='Predicted crime : Act 279-Accident'
        elif my_prediction[0][3] == 1:
            prediction='Predicted crime : Act 323-Violence'
        elif my_prediction[0][4] == 1:
            prediction='Predicted crime : Act 302-Murder'
        elif my_prediction[0][5] == 1:
            prediction='Predicted crime : Act 363-kidnapping'
        else:
            prediction='Place is safe no crime expected at that timestamp.'
